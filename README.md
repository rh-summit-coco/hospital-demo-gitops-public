...
| CVM / Tekton tasks | Create cluster secrets referenced by tasks (e.g. `azure-credentials`, `azure-ssh-key`, `aws-credentials-bigrock`, `litian-git-credential`) — see [cvm_pipeline/README.md](cvm_pipeline/README.md). | Not stored as files in this repo. |
